      ...
      <div className="animalCardHolder">
        <div className="filterGroup">
          ...
          >
            ...
            <div className="secondFilterGroup">
            <div className="dropdown">
